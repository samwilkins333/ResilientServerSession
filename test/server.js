...
var utilities_1 = require("../dist/utilities/utilities");
var TestSessionAgent = /** @class */ (function (_super) {
    ...
    TestSessionAgent.prototype.initializeMonitor = function (monitor) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, utilities_1.Utilities.guid()];
            });
        });
    };
    TestSessionAgent.prototype.initializeServerWorker = function () {
        return __awaiter(this, void 0, void 0, function () {
            var worker;
            return __generator(this, function (_a) {
                worker = server_worker_1.ServerWorker.Create(function () {
                    var app = express();
                    app.listen(3000, function () { return console.log("Dummy server listening on 3000!"); });
                });
                worker.addExitHandler(function () { return console.log("GOODBYE!"); });
